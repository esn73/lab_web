...
/**
 * Servlet implementation class SeccionTestServlet
 */
@WebServlet(name = "seccionTestServlet", urlPatterns = { "/seccion-test" })
public class SeccionTestServlet extends HttpServlet {
