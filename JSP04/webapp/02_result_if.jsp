...
String colorValue = "" ; // 실제 색상을 저장하기 위한 변수
	colorValue = "red";
if (color.equals("r")) { // 요청 파라미터 값이 "r"이면
	colorValue = "red";
...
%>
<%-- JSTL 태그를 사용한 Java if 문 대체 --%>
<c:set var="colorValue2" value="black"></c:set> <%-- 요청 파라미터에 color가 없을 때 사용한 기본 값 --%>
<c:if test="${ param.color =='r' }"> <%--String userName = request.getParameter("userName") 연산자 사용 equals 사용x 자바스크립트랑 같음--%>
