...
public class BoardUpeateController implements Action {
	...
	private String doGet(HttpServletRequest request, HttpServletResponse response) {
		// TODO 게시글을 수정할 수 있는 UI를 보여줌.
		System.out.println("boardUpdateController.doGet() 메서드 호출");
		
		// 요청 파라미터
		int bno = Integer.parseInt(request.getParameter("bno"));
		// 글번호 bno에 해당하는 게시글의 내용을 수정 가능한 form 양식으로 만들어서 보여줌
	...
	private String doPost(HttpServletRequest request, HttpServletResponse response) {
		// TODO 수정된 게시글의 내용을 DB에 update. -> 게시판 메인으로 이동(or 상세보기페이지) redirect
