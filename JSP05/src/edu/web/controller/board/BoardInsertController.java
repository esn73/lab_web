...
public class BoardInsertController implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("boardInsertController.execute() 호출");
	...
	private String doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		String title = request.getParameter("title"); // 사용자 form에 입력한 글 제목
		String content =  request.getParameter("content"); // 사용자가 form에 입력한 글 내용
		String userId = request.getParameter("userId");// 글 작성자 아이디 - board insert jsp form 기준
