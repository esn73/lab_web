...
/**
 * Servlet implementation class RedirectTestSevlet
 */
//@WebServlet("/")
public class RedirectTestSevlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RedirectTestSevlet() {}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		// redirect 방식의 페이지 이동: 
		// 요청(request)을 받은 페이지가 응답(response)를 처리하지 않음.
