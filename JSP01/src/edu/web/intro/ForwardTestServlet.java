 ...
 */
// Selvlet 클래스는 처리할 수 있는 URL 패턴을 매핑시켜야 함.
// URL 패턴 매핑 방법 1: @WebServlet 어노테이션(annotation)을 이용.
// 배포 관리자(deployment descriptor, web.xml)에서 설정.
//@WebServlet("/forward")
public class ForwardTestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
    	...
    	RequestDispatcher dispatcher = request.getRequestDispatcher("forward.jsp"); // /https:/www.google.com로 기재하면 안됌
    	...
    	// 페이지가 이동하더라도 요청 URL이 유지됨(변경되지 않음).
	}
