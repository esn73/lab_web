...
<html>
	...
	<body>
		<h1>Ajax 소개</h1>
		<h2>Asynchronous JavaScript And XML(자바스크립트를 사용한 비동기 통신 방식)</h2>
		...
		<script src="https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.slim.min.js"></script>
      	...
      	$(document).ready(function (){
      		...
      		$('#btn1').click(function(){
      			...
      			xhr.onload = function (){
      				console.log('xhr.status = ' + xhr.status); //-> 200: 응답 성공
      			...
      			// 3. Ajax 요청을 준비: 요청 방법, 요청 주소, async(기본값)
      		...
      		$('#btn2').click(function(){
      			...
      			// 3. Ajax 요청 준비
      			xhr.open('GET', 'data/city.json'); // async 파라미터의 기본값을 true이기 때문에 생략 가능.
